...
export default function FormikEx1Component() {
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <dl>
                    ...
                    <dd className="form-switch">
                        <input className="form-check-input" name="Subscribe" onChange={formik.handleChange} checked={formik.values.Subscribe} type="checkbox"/>Yes</dd>
                </dl>
